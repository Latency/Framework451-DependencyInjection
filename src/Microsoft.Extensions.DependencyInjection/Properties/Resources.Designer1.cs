...
{
    private static readonly ResourceManager _resourceManager = new("Microsoft.Extensions.DependencyInjection.Resources", typeof(Resources).Assembly);


    internal static string FormatAmbigiousConstructorException(object? p0) => string.Format(CultureInfo.CurrentCulture, GetString("AmbigiousConstructorException"), p0);
    ...
    /// <summary>
    ///     A suitable constructor for type '{0}' could not be located. Ensure the type is concrete and services are registered
