...
// File:     ServiceCollectionDescriptorExtensions.cs
...
namespace Microsoft.Extensions.DependencyInjection.Abstractions.Extensions;
...
public static class ServiceCollectionDescriptorExtensions
{
    ...
    public static void TryAddTransient<TService>(this IServiceCollection services, Func<IServiceProvider, TService>? implementationFactory)
        where TService : class => services.TryAdd(ServiceDescriptor.Transient(implementationFactory));
    ...
    public static void TryAddScoped<TService>(this IServiceCollection services, Func<IServiceProvider, TService>? implementationFactory)
        where TService : class => services.TryAdd(ServiceDescriptor.Scoped(implementationFactory));
    ...
    public static void TryAddSingleton<TService>(this IServiceCollection services, Func<IServiceProvider, TService>? implementationFactory)
        where TService : class => services.TryAdd(ServiceDescriptor.Singleton(implementationFactory));
    ...
    public static void TryAddEnumerable(this IServiceCollection services, ServiceDescriptor descriptor)
    {
        ...
        if (implementationType == typeof(object) || implementationType == descriptor.ServiceType)
            throw new ArgumentException(Resources.FormatTryAddIndistinguishableTypeToEnumerable(implementationType, descriptor.ServiceType), nameof(descriptor));
